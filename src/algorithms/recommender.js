...
export const CINEPHILE_DIRECTORS = [
  // TMDB person ids, each checked against the person's name and directed films.
  { id: 10099,  name: "Park Chan-wook"            },
  { id: 12453,  name: "Wong Kar-wai"              },
  { id: 4415,   name: "Federico Fellini"          },
  { id: 6648,   name: "Ingmar Bergman"            },
  { id: 68813,  name: "Céline Sciamma"            },
  { id: 608,    name: "Hayao Miyazaki"            },
  { id: 6817,   name: "Agnès Varda"               },
  { id: 15488,  name: "Ken Loach"                 },
  { id: 309,    name: "Pedro Almodóvar"           },
  { id: 6011,   name: "Michael Haneke"            },
  { id: 21684,  name: "Bong Joon-ho"              },
  { id: 5026,   name: "Akira Kurosawa"            },
  { id: 1650,   name: "François Truffaut"         },
  { id: 3776,   name: "Jean-Luc Godard"           },
  { id: 8452,   name: "Andrei Tarkovsky"          },
  { id: 119294, name: "Abbas Kiarostami"          },
  { id: 42,     name: "Lars von Trier"            },
  { id: 9888,   name: "Claire Denis"              },
  { id: 69759,  name: "Apichatpong Weerasethakul" },
  { id: 56214,  name: "Nuri Bilge Ceylan"         },
  { id: 122423, name: "Yorgos Lanthimos"          },
  { id: 12160,  name: "Satyajit Ray"              },
  { id: 95501,  name: "Yasujirō Ozu"              },
  { id: 10346,  name: "Robert Bresson"            },
  { id: 150975, name: "Hong Sang-soo"             },
  { id: 56208,  name: "Lucrecia Martel"           },
  { id: 30715,  name: "Terrence Malick"           },
  { id: 6818,   name: "Werner Herzog"             },
  { id: 2725,   name: "Rainer Werner Fassbinder"  },
  { id: 28615,  name: "Éric Rohmer"               },
  { id: 24882,  name: "Jacques Demy"              },
  { id: 4429,   name: "Jim Jarmusch"              },
  { id: 2303,   name: "Wim Wenders"               },
  { id: 97202,  name: "Kenji Mizoguchi"           },
  { id: 256841, name: "Pedro Costa"               },
  { id: 130030, name: "Chantal Akerman"           },
  { id: 85637,  name: "Béla Tarr"                 },
